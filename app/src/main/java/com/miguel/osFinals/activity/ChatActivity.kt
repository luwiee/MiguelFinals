...
import com.miguel.osFinals.RetrofitInstance
import com.miguel.osFinals.adapter.ChatAdapter
import com.miguel.osFinals.model.Chat
import com.miguel.osFinals.model.NotificationData
...
class ChatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSendMessage.setOnClickListener {
            ...
            if (message.isEmpty()) {
                ...
                sendMessage(firebaseUser!!.uid, userId, message, profileImage!!)
                etMessage.setText("")
                topic = "/topics/$userId"
    ...
    private fun sendMessage(senderId: String, receiverId: String, message: String, profileImage: String) {
